...
class TipoCadastroList extends TPage
{
    private $form; // form
    ...
    public function __construct($param = null)
    {
        ...
        $this->form->setFormTitle("Listagem de tipo cadastros");
        $this->limit = 20;
        ...
        $btn_onshow = $this->form->addAction("Cadastrar", new TAction(['TipoCadastroForm', 'onShow']), 'fas:plus #69aa46');
        ...
        $action_onDelete = new TDataGridAction(array('TipoCadastroList', 'onDelete'));
        ...
        $dropdown_button_exportar->addPostAction( "CSV", new TAction(['TipoCadastroList', 'onExportCsv'],['static' => 1]), 'datagrid_'.self::$formName, 'fas:file-csv #00b894' );
        $dropdown_button_exportar->addPostAction( "XLS", new TAction(['TipoCadastroList', 'onExportXls'],['static' => 1]), 'datagrid_'.self::$formName, 'fas:file-excel #4CAF50' );
        $dropdown_button_exportar->addPostAction( "PDF", new TAction(['TipoCadastroList', 'onExportPdf'],['static' => 1]), 'datagrid_'.self::$formName, 'far:file-pdf #e74c3c' );
        $dropdown_button_exportar->addPostAction( "XML", new TAction(['TipoCadastroList', 'onExportXml'],['static' => 1]), 'datagrid_'.self::$formName, 'far:file-code #95a5a6' );
        ...
        if(empty($param['target_container']))
        {
            $container->add(TBreadCrumb::create(["Estoque","Tipo cadastros"]));
        }
