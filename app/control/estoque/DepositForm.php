...
class DepositForm extends TPage
{
    protected $form;
    private $formFields = [];
    ...
    private static $formName = 'form_DepositForm';
    ...
    public function onSave($param = null) 
    {
        try
        {
            ...
            $object = new Deposit(); // create an empty object 
    ...
    public function onEdit( $param )
    {
        try
        {
            if (isset($param['key']))
            {
                ...
                $object = new Deposit($key); // instantiates the Active Record 
