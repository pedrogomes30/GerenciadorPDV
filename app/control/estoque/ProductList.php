...
class ProductList extends TPage
{
    ...
    private static $formName = 'form_ProductList';
    ...
    public function __construct($param = null)
    {
        ...
        $dropdown_button_exportar->addPostAction( "XLS", new TAction(['ProductList', 'onExportXls'],['static' => 1]), 'datagrid_'.self::$formName, 'fas:file-excel #4CAF50' );
        $dropdown_button_exportar->addPostAction( "PDF", new TAction(['ProductList', 'onExportPdf'],['static' => 1]), 'datagrid_'.self::$formName, 'far:file-pdf #e74c3c' );
        $dropdown_button_exportar->addPostAction( "XML", new TAction(['ProductList', 'onExportXml'],['static' => 1]), 'datagrid_'.self::$formName, 'far:file-code #95a5a6' );
