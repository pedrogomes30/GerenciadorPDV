...
class CashierList extends TPage
{
    private $form; // form
    ...
    private static $formName = 'form_CashierList';
    ...
    public function __construct($param = null)
    {
        ...
        $btn_onshow = $this->form->addAction("Cadastrar", new TAction(['CashierForm', 'onShow']), 'fas:plus #69aa46');
        ...
        $action_onDelete = new TDataGridAction(array('CashierList', 'onDelete'));
        ...
        $dropdown_button_exportar->addPostAction( "XLS", new TAction(['CashierList', 'onExportXls'],['static' => 1]), 'datagrid_'.self::$formName, 'fas:file-excel #4CAF50' );
        $dropdown_button_exportar->addPostAction( "PDF", new TAction(['CashierList', 'onExportPdf'],['static' => 1]), 'datagrid_'.self::$formName, 'far:file-pdf #e74c3c' );
        $dropdown_button_exportar->addPostAction( "XML", new TAction(['CashierList', 'onExportXml'],['static' => 1]), 'datagrid_'.self::$formName, 'far:file-code #95a5a6' );
        ...
        if(empty($param['target_container']))
        {
            $container->add(TBreadCrumb::create(["Sistema","Caixas"]));
        }
    ...
    public function onReload($param = NULL)
    {
        try
        {
            ...
            // creates a repository for Cashier
