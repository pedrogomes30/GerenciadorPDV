...
class PaymentMethodForm extends TPage
{
    ...
    private static $formName = 'form_PaymentMethodForm';
    ...
    public function onSave($param = null) 
    {
        try
        {
            ...
            $object = new PaymentMethod(); // create an empty object 
    ...
    public function onEdit( $param )
    {
        try
        {
            if (isset($param['key']))
            {
                ...
                $object = new PaymentMethod($key); // instantiates the Active Record 
