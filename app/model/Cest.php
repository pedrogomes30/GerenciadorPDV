...
class Cest extends TRecord
{
    ...
    public function getCestNcms()
    {
        ...
        $criteria->add(new TFilter('cest', '=', $this->id));
    ...
    public function get_cest_ncm_fk_cest_to_string()
    {
        ...
        $values = CestNcm::where('cest', '=', $this->id)->getIndexedArray('cest','{fk_cest->id}');
    ...
    public function get_cest_ncm_fk_ncm_to_string()
    {
        ...
        $values = CestNcm::where('cest', '=', $this->id)->getIndexedArray('ncm','{fk_ncm->id}');
        return implode(', ', $values);
    }
