...
class ProductType extends TRecord
{
    ...
    public function getProducts()
    {
        ...
        $criteria->add(new TFilter('type', '=', $this->id));
    ...
    public function get_product_fk_cest_ncm_to_string()
    {
        ...
        $values = Product::where('type', '=', $this->id)->getIndexedArray('cest_ncm','{fk_cest_ncm->id}');
    ...
    public function get_product_fk_provider_to_string()
    {
        ...
        $values = Product::where('type', '=', $this->id)->getIndexedArray('provider','{fk_provider->social_name}');
        return implode(', ', $values);
    }
    ...
    public function get_product_fk_brand_to_string()
    {
        ...
        $values = Product::where('type', '=', $this->id)->getIndexedArray('brand','{fk_brand->name}');
        return implode(', ', $values);
    }
    ...
    public function get_product_fk_type_to_string()
    {
        ...
        $values = Product::where('type', '=', $this->id)->getIndexedArray('type','{fk_type->description}');
        return implode(', ', $values);
    }
    ...
    public function get_product_fk_status_to_string()
    {
        ...
        $values = Product::where('type', '=', $this->id)->getIndexedArray('status','{fk_status->status}');
        return implode(', ', $values);
    }
    ...
    public function get_product_fk_category_to_string()
    {
        ...
        $values = Product::where('type', '=', $this->id)->getIndexedArray('category','{fk_category->name}');
        return implode(', ', $values);
    }
